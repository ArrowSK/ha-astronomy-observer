...
cp "$APK" "$ANDROID_DIR/generated/apk/astronomy-observer-0.3.4-debug.apk"

echo "Installable debug-signed APK: android/generated/apk/astronomy-observer-0.3.4-debug.apk"
