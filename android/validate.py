...
def main() -> None:
    ...
    require('versionName = "0.3.0"' in gradle, "Android version must match 0.3.0 release")
    ...
    require("ARG BUILD_VERSION=0.3.0" in (HA / "Dockerfile").read_text(encoding="utf-8"), "container version mismatch")
