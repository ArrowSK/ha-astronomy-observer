...
def main() -> None:
    ...
    require('versionName = "0.3.2"' in gradle, "Android version must match 0.3.2 release")
    ...
    require('version: "0.3.2"' in ha_config, "Home Assistant version must match Android release")
    require("ARG BUILD_VERSION=0.3.2" in (HA / "Dockerfile").read_text(encoding="utf-8"), "container version mismatch")
